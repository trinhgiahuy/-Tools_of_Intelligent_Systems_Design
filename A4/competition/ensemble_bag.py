...
reshaped_test_flat = reshaped_test.reshape(number_of_test_data_points, -1)
X_test_scaled_flat = scaler.fit_transform(reshaped_test_flat)
...
for i in range(num_models):
    ...
    X_train, X_val, y_train, y_val = train_test_split(reshaped_features, labels, test_size=0.2, random_state=seeds[i])
